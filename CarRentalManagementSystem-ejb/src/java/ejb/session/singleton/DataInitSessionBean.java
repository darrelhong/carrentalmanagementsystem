...
public class DataInitSessionBean {
    ...
    private void initialiseData() {
        try {
            ...
            Employee admin2 = new Employee("Default Admin", "admin2", "password", EmployeeType.ADMIN);
            Employee sales2 = new Employee("Default Sales", "sales2", "password", EmployeeType.SALES);
            Employee operations2 = new Employee("Default Operations", "operations2", "password", EmployeeType.OPERATIONS);
            Employee custSvc2 = new Employee("Default Cust Svc", "custsvc2", "password", EmployeeType.CUSTOMERSERVICE);
